/* 특정 test 계정으로 로그인한다. 적합하지 않은 방법이다.
package com.kh.khculture.provider;
	...
	KAKAO {
		...
		public ClientRegistration.Builder getBuilder() {
			return getBuilder("kakao", ClientAuthenticationMethod.POST)
					...
					.clientId("c62fd21fe68a0f32a4975d8a5b495742")
					.clientSecret("R87Z2ilFpe74SYnlEQqC8QjOY6OK7pKA")
